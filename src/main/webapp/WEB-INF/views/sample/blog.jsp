...
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/resources/css/blog_styles.css">
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/resources/css/blog_responsive.css">
			...
			<div class="row">
				<div class="col">
					<div class="blog_posts d-flex flex-row align-items-start justify-content-between">
						...
						<!-- Blog post -->
						<div class="blog_post">
							<div class="blog_image" style="background-image:url(${PATH+=FRONTPAGE_DIR_IMAGES}/blog_1.jpg)"></div>
						...
						<!-- Blog post -->
						<div class="blog_post">
							<div class="blog_image" style="background-image:url(${PATH+=FRONTPAGE_DIR_IMAGES}/blog_2.jpg)"></div>
						...
						<!-- Blog post -->
						<div class="blog_post">
							<div class="blog_image" style="background-image:url(${PATH+=FRONTPAGE_DIR_IMAGES}/blog_3.jpg)"></div>
						...
						<!-- Blog post -->
						<div class="blog_post">
							<div class="blog_image" style="background-image:url(${PATH+=FRONTPAGE_DIR_IMAGES}/blog_4.jpg)"></div>
						...
						<!-- Blog post -->
						<div class="blog_post">
							<div class="blog_image" style="background-image:url(${PATH+=FRONTPAGE_DIR_IMAGES}/blog_5.jpg)"></div>
						...
						<!-- Blog post -->
						<div class="blog_post">
							<div class="blog_image" style="background-image:url(${PATH+=FRONTPAGE_DIR_IMAGES}/blog_6.jpg)"></div>
						...
						<!-- Blog post -->
						<div class="blog_post">
							<div class="blog_image" style="background-image:url(${PATH+=FRONTPAGE_DIR_IMAGES}/blog_7.jpg)"></div>
						...
						<!-- Blog post -->
						<div class="blog_post">
							<div class="blog_image" style="background-image:url(${PATH+=FRONTPAGE_DIR_IMAGES}/blog_8.jpg)"></div>
						...
						<!-- Blog post -->
						<div class="blog_post">
							<div class="blog_image" style="background-image:url(${PATH+=FRONTPAGE_DIR_IMAGES}/blog_9.jpg)"></div>
