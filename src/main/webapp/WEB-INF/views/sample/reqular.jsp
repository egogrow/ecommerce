...
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/resources/css/front-end/regular_styles.css">
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/resources/css/front-end/regular_responsive.css">
				...
				<div class="col-lg-8 offset-lg-2">
					...
					<div class="single_post_text">
						...
						<div class="single_post_quote text-center">
							<div class="quote_image"><img src="${pageContext.request.contextPath}/resources/images/front-end/quote.png" alt=""></div>
...
<script src="${pageContext.request.contextPath}/resources/js/front-end/regular_custom.js"></script>
</body>
